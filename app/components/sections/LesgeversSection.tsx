...
const LesgeversSection: React.FC = () => {
    return (
        <section id='lesgevers' className='w-full h-full flex justify-center items-center flex-col pt-[100px] px-5'>
            <h2 className='text-[36px] font-bold text-center'>Lesgevers</h2>
            <p className='text-[20px] max-w-[800px] text-center pt-3'>Elk van onze lesgevers heeft zijn of haar specialiteit in één of meerdere gevechtssporten. De meeste van onze lesgevers zijn gewezen of recente Mixed Martial Arts kampioenen of hebben titels behaald in diverse gevechtssporten. Bij Perfect Team train je onder begeleiding van echte experten.</p>
            <div className='flex flex-col justify-center items-center w-full max-w-[1300px] mt-[50px] px-5 gap-5 md:gap-10'>
                <div className='flex flex-col sm:flex-row gap-10 sm:gap-5 md:gap-10 w-full sm:w-auto'>
                    <div className='flex justify-center items-center flex-col w-full sm:w-auto'>
                        ...
                        <h1 className='font-semibold text-[28px] mt-3'>Ben Dandois</h1>
                    ...
                    <div className='flex justify-center items-center flex-col w-full sm:w-auto'>
                        ...
                        <h1 className='font-semibold text-[28px] mt-3'>Chris Van Boom</h1>
                ...
                <div className='flex flex-col sm:flex-row gap-10 sm:gap-5 md:gap-10  w-full sm:w-auto'>
                    <div className='flex justify-center items-center flex-col w-full sm:w-auto'>
                        ...
                        <h1 className='font-semibold text-[28px] mt-3'>Mo Toualla</h1>
                    ...
                    <div className='flex justify-center items-center flex-col w-full sm:w-auto'>
                        ...
                        <h1 className='font-semibold text-[28px] mt-3'>Tarik Jaaidi</h1>
                        <p className='text-[20px]'>Striking Coach</p>
                    </div>
                    <div className='hidden lg:flex justify-center items-center flex-col w-full sm:w-auto'>
                        ...
                        <h1 className='font-semibold text-[28px] mt-3'>Youssef Addib</h1>
                ...
                <div className='flex flex-col sm:flex-row gap-10 sm:gap-5 md:gap-10  w-full sm:w-auto'>
                    ...
                    <div className='flex justify-center items-center flex-col w-full sm:w-auto'>
                        ...
                        <h1 className='font-semibold text-[28px] mt-3'>Anthony Lambrechts</h1>
                        <p className='text-[20px]'>MMA Coach</p>
                    </div>
                    <div className='hidden lg:flex justify-center items-center flex-col w-full sm:w-auto'>
                        <div className='relative rounded-full w-full max-w-[400px] aspect-square sm:w-[300px] sm:h-[300px] lg:w-[300px] lg:h-[300px]'>
                        ...
                        <h1 className='font-semibold text-[28px] mt-3'>Victoria Sabbar</h1>
