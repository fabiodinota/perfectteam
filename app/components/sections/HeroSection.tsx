...
const HeroSection = () => {
	...
	return (
		<section
			id="home"
			className="h-[86dvh] overflow-hidden relative flex justify-center items-end"
		>
			<div className="w-screen max-w-[1300px] mx-5 relative z-10 mb-20">
				...
				>
					Bij Perfect Team MMA combineren we topinstructie met
					eersteklas faciliteiten in Deurne. Voor beginners tot
					pro&apos;s: sluit je aan bij ons kampioensteam!
				</p>
				<button
					data-aos="fade-up"
					data-aos-duration="1000"
			...
			<motion.div
				className="h-full absolute top-0 left-0 w-screen z-0"
				style={{ y: heroImageY }}
			>
				<Image
					src={HeroImage}
