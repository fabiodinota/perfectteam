  ...
  return (
    <section id='aanbod' className='w-full h-full flex justify-center items-center flex-col pt-[100px] px-5'>
        ...
        <AanbodComponent 
            ...
            imageSide='left'
        />
        <Socials facebook instagram Text='Volg onze kids op Social Media' color={"#F28927"} />
        <div
            className={`w-full h-full flex flex-col lg:flex-row justify-center items-center gap-10 max-w-[1300px] mt-[100px]`}
        >
            <div
                className="relative w-full max-w-[700px] lg:w-[550px] flex-shrink-0 aspect-[638/425]"
            >
                <Image
                    sizes="400px"
                    src={Women}
            ...
            >
                <h1 className="text-[22px] sm:text-[28px] pb-2 font-semibold flex justify-center items-start flex-col">
                    <span className='text-[24px] opacity-50'>Ladies Only</span>
                    By Victory Fight To Be Fit
                </h1>
                <p className="text-[20px] sm:pb-0 font-extralight">
                    Ben je een vrouw en ben je op zoek naar een leuke ladies only groepsworkout geschikt voor alle niveaus? Hou je van kickboksen, HIIT, kracht- en crosstraining? 
                    <br />
                    <br />
                    Maak een reservatie via de Victoria Fight To Be Fit website:
                    <br />
                    <br />
                    <a className='text-green' href="">Victory Fight To Be Fit Website </a>
                </p>
            </div>
        </div>
        <Socials facebook instagram Text='Volg onze ladies op Social Media' color={"#ED74DA"} />
