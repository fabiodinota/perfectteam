...
const AanbodComponent = ({ image, title, description, imageSide, age }: AanbodComponentProps) => {
  return (
    <div
    className={`w-full h-full flex ${imageSide === "right" ? "flex-col-reverse" : "flex-col" } lg:flex-row justify-center items-center gap-10 max-w-[1300px] mt-[100px]`}
    >
        {imageSide === 'left' && (
            <div
